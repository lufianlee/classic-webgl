      ...
      <div>
        <div className="flex items-baseline gap-3 mb-1">
          <div className="display text-base leading-tight">
            {seg?.heading ?? 'Overview'}
          </div>
          <div className="text-[10px] opacity-55 tracking-wider font-mono">
            {seg
  ...
  return (
    ...
    >
      <div className="parchment-panel px-5 py-3">
        <div className="text-[10px] tracking-[0.3em] opacity-55 mb-1">
          COMMENTARIUS
        </div>
        {body}
      </div>
